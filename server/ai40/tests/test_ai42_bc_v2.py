...
class AI42BCV2Tests(unittest.TestCase):
    def test_production_config_has_single_data_derived_policy(self) -> None:
        ...
        self.assertIsNone(defaults["supervision_controllers"])
        parser = train_ai42_bc.build_parser()
        parser.set_defaults(**defaults)
        parsed = parser.parse_args(["--supervision-controller", "3"])
        self.assertEqual(parsed.supervision_controllers, [3])
