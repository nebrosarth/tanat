...
def _training_config_defaults(path: Path) -> dict[str, Any]:
    ...
    required_learner = {
        "class_balance_power", "offset_distance_loss_weight", "max_gradient_norm",
    ...
    return {
        ...
        **recurrent,
        ...
        "offset_distance_loss_weight": learner["offset_distance_loss_weight"],
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--offset-distance-loss-weight", type=float, default=1.0)
...
def _validate_training_args(args: argparse.Namespace) -> None:
    ...
    distance_weight = _finite_number(
        args.offset_distance_loss_weight, "offset-distance-loss-weight",
    )
    if distance_weight < 0.0:
        raise AI42TrainingError("offset-distance-loss-weight must be non-negative")
...
def prepare_training_context(args: argparse.Namespace) -> AI42TrainingContext:
    ...
    learner_config = AI42LearnerConfig(
        ...
        offset_distance_loss_weight=args.offset_distance_loss_weight,
