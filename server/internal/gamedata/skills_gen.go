// Code generated by scratchpad/gen_skills.go.py from skillspecs/*.json. DO NOT EDIT.
		...
		Skills: [4]Skill{
			{
				...
				BuffFx: "", BuffFxOn: "", BuffIcon: false, BuffDescVariant: "",
				Ops: []Op{
					{Kind: OpSummon, Count: PerLevel{1, 1, 1, 1}, Lifetime: PerLevel{180, 180, 180, 180}, HP: PerLevel{300, 420, 540, 660}, Dmg: PerLevel{25, 34, 43, 52}, Unit: "Mob_Dinosaur_Melee_01"},
				},
				TipArgs: map[string]PerLevel{
